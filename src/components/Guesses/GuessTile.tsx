...
const GuessTile: Component<GuessTileProps> = (props) => {
  const classes = createMemo(() =>
    cs(
      "w-16 h-16 inline-flex justify-center items-center text-4xl leading-8 font-bold box-border align-middle border-slate-700 dark:border-slate-200 border-2",
      {
